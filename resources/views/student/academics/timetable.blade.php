...
@section('title', 'Weekly Class Timetable')
@section('header', 'Weekly Class Timetable')
@section('subheader', 'Lecture Schedule & Subject Timetable Matrix')
...
<div class="space-y-6">
    ...
    <div class="flat-table-wrapper">
        <div class="p-5 border-b border-slate-100 dark:border-slate-800/80 flex items-center justify-between">
            <h3 class="text-sm font-bold text-slate-900 dark:text-white">Class Schedule: {{ $student->schoolClass->name }} - {{ $student->section->name }}</h3>
