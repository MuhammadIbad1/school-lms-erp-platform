...
@section('title', $child->user->name . ' - Attendance Log')
@section('header', 'Child Attendance History')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div class="glass-card p-6">
            <p class="text-xs font-bold uppercase tracking-wider text-slate-500">Aggregate Rate</p>
            <h3 class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-1 font-display">{{ $percentage }}%</h3>
        </div>
        <div class="glass-card p-6">
            <p class="text-xs font-bold uppercase tracking-wider text-slate-500">Classes Attended</p>
    ...
    <div class="flat-table-wrapper">
        <div class="p-5 border-b border-slate-100 dark:border-slate-800/80">
            <h3 class="text-sm font-bold text-slate-900 dark:text-white">Daily Attendance Record</h3>
        </div>
            ...
            <table class="w-full text-left text-xs text-slate-600 dark:text-slate-300">
                <thead class="bg-slate-50/80 dark:bg-slate-800/40 text-slate-400 uppercase text-[10px] font-bold">
                    <tr>
                        ...
                        <th class="px-5 py-4">Remarks / Notes</th>
                    </tr>
                </thead>
